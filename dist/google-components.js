      ...
      >
        <div class="content">
          ...
          <div class="text">
            ...
            ${l==Rt.MEASUREMENT||this._config.control_type==zt.SCENE&&d||this._config.control_type==zt.MEDIA_PLAYER&&!o?G``:G`<div class="state-wrapper">
