      ...
      >
        <div class="content">
          ...
          <div class="text">
            ...
            ${h==Dt.MEASUREMENT||this._config.control_type==Rt.SCENE&&u||this._config.control_type==Rt.MEDIA_PLAYER&&!r||this._config.control_type==Rt.ACTION||f?G``:G`<div class="state-wrapper">
