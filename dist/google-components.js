      ...
      >
        <div class="content">
          ...
          <div class="text">
            ...
            ${l==Ut.MEASUREMENT||this._config.control_type==Dt.SCENE&&d||this._config.control_type==Dt.MEDIA_PLAYER&&!o?G``:G`<div class="state-wrapper">
        ...
        ${r?G`<ha-icon
              ...
              title="Offline"
            ></ha-icon>`:this._config.control_type==Dt.THERMOMETER||this._config.control_type==Dt.MEDIA_PLAYER?G`<ha-icon
  ...
  `,n([pt({attribute:!1})],yn.prototype,"hass",void 0),n([ft()],yn.prototype,"_config",void 0),n([ft()],yn.prototype,"_configLoaded",void 0),yn=n([ht("google-control-card-editor")],yn);let wn=class extends ct{constructor(){super(...arguments),this._config=i,this._valueChanged=t=>{var e,i;const n=t.target,o=n.getAttribute("configValue"),s=t instanceof CustomEvent&&void 0!==(null===(e=t.detail)||void 0===e?void 0:e.value)?t.detail.value:null!==(i=n.checked)&&void 0!==i?i:n.value;o&&this._config[o]!==s&&(this._config=Object.assign(Object.assign({},this._config),{[o]:s}),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}})))}}setConfig(t){this._config=Object.assign({},t)}_entityChanged(t){var e;const i=t.detail.value;(null===(e=this._config)||void 0===e?void 0:e.entity)!==i&&(this._config=Object.assign(Object.assign({},this._config),{entity:i}),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}})))}async firstUpdated(){const t=await window.loadCardHelpers(),e=await t.createCardElement({type:"entities",entities:[]});await e.constructor.getConfigElement()}setEntityFilter(){switch(this._config.control_type){case Dt.THERMOMETER:return["climate"];case Dt.SCENE:return["scene","automation"];case Dt.MEDIA_PLAYER:return["media_player"];default:return}}render(){var t,e,i,n,o,s,a,r,l,c,d;return this._config&&this.hass?(this._config.use_default_icon=null===(t=this._config.use_default_icon)||void 0===t||t,this._config.use_default_toggle=null===(e=this._config.use_default_toggle)||void 0===e||e,this._config.use_default_text=null===(i=this._config.use_default_text)||void 0===i||i,G`
      <div class="form">
        ...
        ${this._config.use_default_text?G``:G`
            ...
            `}
        ${this._config.control_type!=Dt.THERMOMETER?G``:G` <div class="switch-row">
                <span class="switch-label"
                  >${Lt("google_climate_card.theme")}</span
                >
                <ha-switch
