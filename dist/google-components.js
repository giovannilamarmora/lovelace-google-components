      ...
      >
        <div class="content">
          ...
          <div class="text">
            ...
            ${r==It.MEASUREMENT||this._config.control_type==Tt.SCENE&&!this._config.use_default_text||this._config.control_type==Tt.MEDIA_PLAYER&&!n?W``:W`<div class="state-wrapper">
